...
public:
    ...
    void drawLine(QString id, QString info, qreal fromLat,qreal fromLng,qreal toLat,qreal toLng,int xOffsetStart,int yOffsetStart,int xOffsetEnd,int yOffsetEnd, int lineSkew, QString color = "red");
