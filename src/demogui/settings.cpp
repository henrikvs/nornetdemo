#include "settings.h"
#include <QString>
QString Settings::sliverKey = "settings/sliverKey";
QString Settings::sliceName = "settings/sliceName";
QString Settings::gatekeeperKey = "settings/gatekeeperKey";
QString Settings::gatekeeperEnabled = "settings/gatekeeperEnabled";
QString Settings::programName = "nornetdemo";
