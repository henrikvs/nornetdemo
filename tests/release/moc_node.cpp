...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Node_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 18, 8)
    ...
    "Node\0setLocation\0\0location\0"
};
...
void Node::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->setLocation((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject Node::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Node.data,
      qt_meta_data_Node,  qt_static_metacall, 0, 0}
};
