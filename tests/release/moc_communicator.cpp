...
#include "../../src/libs/communicator.h"
...
QT_MOC_LITERAL(3, 28, 8)
    ...
    "Communicator\0foundLocation\0\0location\0"
};
...
void Communicator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->foundLocation((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Communicator::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Communicator::foundLocation)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Communicator::foundLocation(QString _t1)
{
