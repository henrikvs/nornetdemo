...
#include "../../src/libs/sshconnection.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SSHConnection_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 35, 9)
    ...
    "SSHConnection\0outputSignal\0\0output\0"
    "newOutput\0"
};
...
void SSHConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SSHConnection::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SSHConnection::outputSignal)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject SSHConnection::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SSHConnection.data,
      qt_meta_data_SSHConnection,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SSHConnection.stringdata))
...
// SIGNAL 0
void SSHConnection::outputSignal(QString _t1)
{
